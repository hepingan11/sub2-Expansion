...
export default function VideoPage() {
    ...
    const deleteSelectedLogs = () => {
        ...
        void Promise.all([deleteStoredMedia(mediaKeys), ...selectedLogIds.map((id) => logStore.removeItem(`${activeStorageScope()}:${id}`))]).then(() => refreshLogs());
    ...
    const saveLog = async (log: GenerationLog, resumePending = true) => {
        await logStore.setItem(`${activeStorageScope()}:${log.id}`, serializeLog(log));
