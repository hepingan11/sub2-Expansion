export default {
    accounts: {
      ...
      video: {
        format: 'API format',
        baseUrlHint: 'API origin or a complete OpenAI Videos endpoint. The default path is /v1/videos.',
        apiKeyHint: 'Sent to the video upstream as an Authorization Bearer token.',
        tokenHint: 'Sent to the ComfyUI upstream as the raw Authorization token without a Bearer prefix.',
        baseUrlRequired: 'Please enter the Video API Base URL',
        comfyBaseUrlHint: 'ComfyUI service origin, for example https://autodl.art.',
        workflowId: 'Workflow ID',
        workflowIdHint: 'A model mapping target overrides this default Workflow ID.',
        workflowIdRequired: 'Please enter the ComfyUI Workflow ID',
        completeEndpoint: 'Base URL is the complete videos endpoint',
        completeEndpointHint: 'Enable when the value already ends with the provider video submission path.',
        openAITestHint: 'Submits POST /v1/videos and polls GET /v1/videos/{id} until the task completes.',
        comfyTestHint: 'Submits a ComfyUI workflow and polls result/{task_id} until it completes.',
        duration: 'Duration (seconds)',
        aspectRatio: 'Aspect ratio',
        resolution: 'Resolution',
        images: 'Reference image URLs (optional)',
        imagesPlaceholder: 'One HTTP/HTTPS URL per line',
        imagesHint: 'Up to 7 URLs. Cannot be combined with a source video URL.',
        sourceVideoUrl: 'Source video URL (optional)',
        sourceVideoHint: 'Use for video-to-video requests. Cannot be combined with reference images.'
      },
      anthropic: {
