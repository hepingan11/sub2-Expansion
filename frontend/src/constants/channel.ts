...
export const BILLING_MODE_VIDEO_PER_SECOND = 'video_per_second' as const
export const BILLING_MODE_VIDEO_PER_REQUEST = 'video_per_request' as const
export type BillingMode =
  | typeof BILLING_MODE_TOKEN
  | typeof BILLING_MODE_PER_REQUEST
  | typeof BILLING_MODE_IMAGE
  | typeof BILLING_MODE_VIDEO
  | typeof BILLING_MODE_VIDEO_PER_SECOND
  | typeof BILLING_MODE_VIDEO_PER_REQUEST
