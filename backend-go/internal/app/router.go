...
func (app *App) router() *gin.Engine {
	...
	protected.GET("/video-account-pools", app.listVideoAccountPools)
	...
	protected.GET("/platforms/:platform/settings", app.getPlatformSettings)
	protected.PUT("/platforms/:platform/settings", app.updatePlatformSettings)
	protected.POST("/telegram/connect", app.connectTelegramBot)
	...
	protected.GET("/lotteries/eligibility", app.previewLotteryEligibility)
	protected.GET("/lotteries", app.listLotteryDraws)
	protected.POST("/lotteries/draw", app.createLotteryDraw)
	protected.POST("/lotteries/:id/retry-awards", app.retryLotteryAwards)
